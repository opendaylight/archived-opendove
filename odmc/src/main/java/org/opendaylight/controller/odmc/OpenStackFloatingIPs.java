...
public class OpenStackFloatingIPs {
    ...
    public OpenStackFloatingIPs extractFields(List<String> fields) {
        OpenStackFloatingIPs ans = new OpenStackFloatingIPs();
