...
public class OpenStackPorts {
    ...
    HashMap<String, OpenStackFloatingIPs> floatingIPMap;

    public OpenStackPorts() {
        floatingIPMap = new HashMap<String, OpenStackFloatingIPs>();
    }
    ...
    public List<OpenStackIPs> getFixedIPs() {
        return fixedIPs;
    }

    public void setFixedIPs(List<OpenStackIPs> fixedIPs) {
    ...
    public OpenStackFloatingIPs getFloatingIP(String key) {
    ...
    public void addFloatingIP(String key, OpenStackFloatingIPs floatingIP) {
        if (!floatingIPMap.containsKey(key))
    ...
    public OpenStackPorts extractFields(List<String> fields) {
        OpenStackPorts ans = new OpenStackPorts();
        ...
        while (i.hasNext()) {
            ...
            if (s.equals("fixed_ips")) {
                List<OpenStackIPs> fixedIPs = new ArrayList<OpenStackIPs>();
    ...
    public void initDefaults() {
        ...
        if (status == null)
            status = "ACTIVE";
        if (fixedIPs == null)
            fixedIPs = new ArrayList<OpenStackIPs>();
    }
